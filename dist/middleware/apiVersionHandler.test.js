...
describe('apiVersionHandler', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('apiVersionHandler');
    }));
    ...
    test('should work if no version header is provided', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield testUtils_1.expectNotThrow(() => __awaiter(this, void 0, void 0, function* () { return apiVersionHandler_1.default(context, testUtils_1.koaNext); }));
        });
    });
    test('should work if the header version number is lower than the server version', function () {
        return __awaiter(this, void 0, void 0, function* () {
            config_1.default().appVersion = '2.1.0';
            const context = yield testUtils_1.koaAppContext({
                request: {
                    method: 'GET',
                    url: '/api/ping',
    ...
    test('should not work if the header version number is greater than the server version', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield testUtils_1.expectHttpError(() => __awaiter(this, void 0, void 0, function* () { return apiVersionHandler_1.default(context, testUtils_1.koaNext); }), errors_1.ErrorPreconditionFailed.httpCode);
        });
    });
});
