...
function handleChangeAdminPasswordNotification(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (defaultAdmin) {
            yield notificationModel.add(ctx.joplin.owner.id, NotificationModel_1.NotificationKey.ChangeAdminPassword, types_1.NotificationLevel.Important, locale_1._('The default admin password is insecure and has not been changed! [Change it now](%s)', urlUtils_1.profileUrl()));
        }
        else {
...
function handleUserFlags(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const flagStrings = flags.map(f => `- ${UserFlagModel_1.userFlagToString(f)}`).join('\n');
        if (!user.enabled || !user.can_upload) {
            return {
                id: 'accountDisabled',
                messageHtml: renderMarkdown_1.default(`Your account is disabled for the following reason(s):\n\n${flagStrings}\n\nPlease check the [help section](${urlUtils_1.helpUrl()}) for further information or contact support.`),
            ...
            return {
                id: 'accountFlags',
                messageHtml: renderMarkdown_1.default(`The following issues have been detected on your account:\n\n${flagStrings}\n\nPlease check the [help section](${urlUtils_1.helpUrl()}) for further information or contact support.`),
...
function handleConfirmEmailNotification(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!ctx.joplin.owner.email_confirmed) {
            return {
                id: 'confirmEmail',
                messageHtml: renderMarkdown_1.default('An email has been sent to you containing an activation link to complete your registration.\n\nMake sure you click it to secure your account and keep access to it.'),
                levelClassName: levelClassName(types_1.NotificationLevel.Important),
                closeUrl: '',
            };
        }
...
function makeNotificationViews(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const n of notifications) {
            views.push({
                id: n.id,
                messageHtml: renderMarkdown_1.default(n.message),
...
function default_1(ctx, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (requestUtils_1.isApiRequest(ctx))
                return next();
            if (!ctx.joplin.owner)
                return next();
