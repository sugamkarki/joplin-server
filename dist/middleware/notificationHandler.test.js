...
const runNotificationHandler = (sessionId) => __awaiter(void 0, void 0, void 0, function* () {
    const context = yield testUtils_1.koaAppContext({ sessionId: sessionId });
    yield notificationHandler_1.default(context, testUtils_1.koaNext);
    return context;
});
describe('notificationHandler', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('notificationHandler');
    }));
    ...
    test('should check admin password', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const r = yield testUtils_1.createUserAndSession(1, true);
            ...
            admin = yield testUtils_1.models().user().save({
                id: admin.id,
            ...
            }, { skipValidation: true });
            {
                ...
                const notifications = yield testUtils_1.models().notification().all();
    ...
    test('should not check admin password for non-admin', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { session } = yield testUtils_1.createUserAndSession(1, false);
            yield testUtils_1.createUserAndSession(2, true, {
                email: db_1.defaultAdminEmail,
                password: db_1.defaultAdminPassword,
            });
    ...
    test('should display a banner if the email is not confirmed', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            {
                yield testUtils_1.models().user().save({ id: user.id, email_confirmed: 1 });
                const ctx = yield runNotificationHandler(session.id);
