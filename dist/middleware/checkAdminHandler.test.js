...
describe('checkAdminHandler', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('checkAdminHandler');
    }));
    ...
    test('should access /admin if the user is admin', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield testUtils_1.expectNotThrow(() => __awaiter(this, void 0, void 0, function* () { return checkAdminHandler_1.default(context, testUtils_1.koaNext); }));
        });
    });
    test('should not access /admin if the user is not admin', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { session } = yield testUtils_1.createUserAndSession(1);
            const context = yield testUtils_1.koaAppContext({
                sessionId: session.id,
                request: {
                    method: 'GET',
            ...
            yield testUtils_1.expectHttpError(() => __awaiter(this, void 0, void 0, function* () { return checkAdminHandler_1.default(context, testUtils_1.koaNext); }), errors_1.ErrorForbidden.httpCode);
        });
    });
