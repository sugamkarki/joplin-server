...
const returningSupported = (db) => {
    return exports.clientType(db) === types_1.DatabaseConfigClient.PostgreSQL;
};
...
function connectDb(dbConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        const connection = knex_1.knex(makeKnexConfig(dbConfig));
