...
function default_1(view) {
    return {
        subject: `Your ${config_1.default().appName} account is over ${view.percentLimit}% full`,
        body: `

Your ${config_1.default().appName} account is over ${view.percentLimit}% full, and as a result it is not longer possible to upload new notes to it.
