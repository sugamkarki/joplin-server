...
const publicDir = `${path_1.dirname(path_1.dirname(__dirname))}/public`;
...
function findLocalFile(path) {
    return __awaiter(this, void 0, void 0, function* () {
        const appFilePath = yield joplinUtils_1.localFileFromUrl(path);
        if (appFilePath)
            return appFilePath;
...
router.get('', (path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!path.id && !path.link) {
        if (ctx.joplin.owner) {
            return routeUtils_1.redirect(ctx, urlUtils_1.homeUrl());
        }
        else {
            return routeUtils_1.redirect(ctx, urlUtils_1.loginUrl());
        }
    }
