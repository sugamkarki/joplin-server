...
const subRoutes = {
    forgot: (_path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const view = defaultView_1.default('password/forgot', 'Reset password');
        view.content = {
            postUrl: urlUtils_1.forgotPasswordUrl(),
            confirmationMessage,
        };
        return view;
    }),
    reset: (_path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const view = defaultView_1.default('password/reset', 'Reset password');
        view.content = {
            postUrl: urlUtils_1.resetPasswordUrl(token),
            error,
            successMessage,
        };
