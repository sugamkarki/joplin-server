...
function getShareContent(shareId, query = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield testUtils_1.checkContextError(context);
        return context.response.body;
    });
}
describe('shares.link', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('shares.link');
    }));
    ...
    test('should display a simple note', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { session } = yield testUtils_1.createUserAndSession();
            const noteItem = yield testUtils_1.createNote(session.id, {
                title: 'Testing title',
                body: 'Testing body',
            });
            const share = yield apiUtils_1.postApi(session.id, 'shares', {
    ...
    test('should render attached images', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield testUtils_1.createItem(session.id, 'root:/96765a68655f4446b3dbad7d41b6566e.md:', resourceContents.image);
            yield testUtils_1.createItem(session.id, 'root:/.resource/96765a68655f4446b3dbad7d41b6566e:', yield fileApiUtils_1.testImageBuffer());
            const share = yield apiUtils_1.postApi(session.id, 'shares', {
                type: types_1.ShareType.Note,
                note_id: noteItem.jop_id,
            });
            ...
            const doc = testUtils_1.parseHtml(bodyHtml);
    ...
    test('should share a linked note', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { session } = yield testUtils_1.createUserAndSession();
            const linkedNote1 = yield testUtils_1.createNote(session.id, {
                id: '000000000000000000000000000000C1',
            });
            const resource = yield testUtils_1.createResource(session.id, {
                id: '000000000000000000000000000000E1',
            }, 'test');
            const linkedNote2 = yield testUtils_1.createNote(session.id, {
                id: '000000000000000000000000000000C2',
                body: `[](:/${resource.jop_id})`,
            });
            const rootNote = yield testUtils_1.createNote(session.id, {
                id: '00000000000000000000000000000001',
    ...
    test('should not share items that are not linked to a shared note', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { session } = yield testUtils_1.createUserAndSession();
            const notSharedResource = yield testUtils_1.createResource(session.id, {
                id: '000000000000000000000000000000E2',
            }, 'test2');
            yield testUtils_1.createNote(session.id, {
            ...
            yield testUtils_1.expectNotThrow(() => __awaiter(this, void 0, void 0, function* () { return getShareContent(share.id, { note_id: '00000000000000000000000000000001' }); }));
            yield testUtils_1.expectHttpError(() => __awaiter(this, void 0, void 0, function* () { return getShareContent(share.id, { note_id: '000000000000000000000000000000C5' }); }), errors_1.ErrorNotFound.httpCode);
            yield testUtils_1.expectHttpError(() => __awaiter(this, void 0, void 0, function* () { return getShareContent(share.id, { note_id: '000000000000000000000000000000E2' }); }), errors_1.ErrorNotFound.httpCode);
        });
    });
    test('should not share linked notes if the "recursive" field is not set', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield testUtils_1.expectHttpError(() => __awaiter(this, void 0, void 0, function* () { return getShareContent(share.id, { note_id: '000000000000000000000000000000C1' }); }), errors_1.ErrorForbidden.httpCode);
        });
    });
    test('should not throw an error if the note contains links to non-existing items', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { session } = yield testUtils_1.createUserAndSession();
            {
                ...
                yield testUtils_1.expectNotThrow(() => __awaiter(this, void 0, void 0, function* () { return getShareContent(share.id); }));
            }
            {
                const noteItem = yield testUtils_1.createNote(session.id, {
    ...
    test('should throw an error if owner of share is disabled', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield testUtils_1.expectHttpError(() => __awaiter(this, void 0, void 0, function* () { return getShareContent(share.id); }), errors_1.ErrorForbidden.httpCode);
        });
    });
});
