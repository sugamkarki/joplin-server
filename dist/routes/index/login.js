...
function makeView(error = null) {
    const view = defaultView_1.default('login', 'Login');
    view.content = {
        error,
        signupUrl: config_1.default().signupEnabled || config_1.default().isJoplinCloud ? routeUtils_1.makeUrl(routeUtils_1.UrlType.Signup) : '',
    };
    return view;
}
...
router.post('login', (_path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    yield limiterLoginBruteForce_1.default(requestUtils_1.userIp(ctx));
    try {
