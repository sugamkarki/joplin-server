...
- Please contact us at [${markdownUtils_1.default.escapeTitleText(config_1.default().supportEmail)}](mailto:${markdownUtils_1.default.escapeLinkUrl(config_1.default().supportEmail)}) for any question.`);
}));
