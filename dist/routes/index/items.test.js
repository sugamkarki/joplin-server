...
describe('index_items', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('index_items');
    }));
    ...
    test('should list the user items', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // the right elements.
            {
                const response = yield apiUtils_1.execRequest(session1.id, 'GET', 'items');
            ...
            {
                const response = yield apiUtils_1.execRequest(session1.id, 'GET', 'items', null, { query: { page: 2 } });
                const navLinks = testUtils_1.parseHtml(response).querySelectorAll('.pagination-link');
