...
router.get('users/:id', (path, ctx, formUser = null, error = null) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const postUrl = `${config_1.default().baseUrl}/users/me`;
    ...
    const view = defaultView_1.default('user', 'Profile');
    view.content.user = formUser ? formUser : user;
    view.content.buttonTitle = locale_1._('Update profile');
...
router.get('users/:id/confirm', (path, ctx, error = null) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const beforeChangingEmailHandler = (newEmail) => __awaiter(void 0, void 0, void 0, function* () {
        if (config_1.default().stripe.enabled) {
            try {
                yield stripe_1.updateCustomerEmail(models, userId, newEmail);
            }
            catch (error) {
    ...
    if (user.must_set_password) {
        const view = Object.assign(Object.assign({}, defaultView_1.default('users/confirm', 'Confirmation')), { content: {
                user,
                error,
                token,
                postUrl: urlUtils_1.confirmUrl(userId, token),
            }, navbar: false });
        view.jsFiles.push('zxcvbn');
        return view;
    }
        ...
        if (ctx.joplin.owner) {
            ...
            return routeUtils_1.redirect(ctx, `${config_1.default().baseUrl}/login`);
        }
    }
}));
...
router.post('users', (path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return routeUtils_1.redirect(ctx, `${config_1.default().baseUrl}/users/me`);
    }
    catch (error) {
