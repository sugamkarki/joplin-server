...
function renderItem(context, item, share) {
    return __awaiter(this, void 0, void 0, function* () {
        if (item.jop_type === BaseModel_1.ModelType.Note) {
            return joplinUtils_1.renderItem(share.owner_id, item, share, context.query);
        }
        return {
            body: item.content,
            mime: item.mime_type,
...
function createContentDispositionHeader(filename) {
    const encoded = encodeURIComponent(path_utils_1.friendlySafeFilename(filename, null, true));
