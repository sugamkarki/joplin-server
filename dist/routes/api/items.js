...
function putItemContents(path, ctx, isBatch) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const parsedBody = yield requestUtils_1.formParse(ctx.req);
        ...
        if (isBatch) {
            ...
            if (totalSize > batchMaxSize)
                throw new errors_1.ErrorPayloadTooLarge(`Size of items (${bytes_1.formatBytes(totalSize)}) is over the limit (${bytes_1.formatBytes(batchMaxSize)})`);
        }
        else {
            const filePath = ((_a = parsedBody === null || parsedBody === void 0 ? void 0 : parsedBody.files) === null || _a === void 0 ? void 0 : _a.file) ? parsedBody.files.file.path : null;
            try {
                ...
                if (filePath)
                    yield fileUtils_1.safeRemove(filePath);
            }
        }
        ...
        for (const [name] of Object.entries(output)) {
            ...
            if (output[name].error)
                output[name].error = errors_1.errorToPlainObject(output[name].error);
        }
        return output;
    });
}
...
router.get('api/items/:id/content', (path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return routeUtils_1.respondWithItemContent(ctx.response, item, serializedContent);
}));
...
router.get('api/items/:id/delta', (_path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return changeModel.delta(ctx.joplin.owner.id, ChangeModel_1.requestDeltaPagination(ctx.query));
}));
router.get('api/items/:id/children', (path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield itemModel.children(ctx.joplin.owner.id, parentName, pagination_1.requestPagination(ctx.query));
    return result;
}));
