...
function startImpersonating(ctx, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        cookies_1.cookieSet(ctx, 'adminSessionId', adminSessionId);
        cookies_1.cookieSet(ctx, 'sessionId', impersonatedSession.id);
    });
}
exports.startImpersonating = startImpersonating;
function stopImpersonating(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        const adminSessionId = cookies_1.cookieGet(ctx, 'adminSessionId');
        if (!adminSessionId)
        ...
        cookies_1.cookieDelete(ctx, 'adminSessionId');
        cookies_1.cookieSet(ctx, 'sessionId', adminSessionId);
    });
}
