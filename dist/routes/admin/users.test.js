...
describe('admin/users', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('admin/users');
    }));
    ...
    test('should create a new user', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newUser = yield testUtils_1.models().user().loadByEmail('test@example.com');
    ...
    test('should format the email when saving it', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const loggedInUser = yield testUtils_1.models().user().login(email, password);
    ...
    test('should list users', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { user: user2 } = yield testUtils_1.createUserAndSession(2, false);
            const result = yield apiUtils_1.execRequest(session1.id, 'GET', 'admin/users');
    ...
    test('should delete sessions when changing password', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { user, session, password } = yield testUtils_1.createUserAndSession(1);
            ...
            const sessions = yield testUtils_1.models().session().all();
    ...
    test('should apply ACL', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { user: admin, session: adminSession } = yield testUtils_1.createUserAndSession(1, true);
            // admin user cannot make themselves a non-admin
            yield testUtils_1.expectHttpError(() => __awaiter(this, void 0, void 0, function* () { return patchUser(adminSession.id, { id: admin.id, is_admin: 0 }); }), errors_1.ErrorForbidden.httpCode);
            // cannot delete own user
            yield testUtils_1.expectHttpError(() => __awaiter(this, void 0, void 0, function* () { return apiUtils_1.execRequest(adminSession.id, 'POST', `admin/users/${admin.id}`, { disable_button: true }); }), errors_1.ErrorForbidden.httpCode);
        });
    });
});
