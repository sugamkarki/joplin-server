...
router.get('admin/user_deletions', (_path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const pagination = table_1.makeTablePagination(ctx.query, 'scheduled_time', pagination_1.PaginationOrderDir.ASC);
    ...
    const table = {
        baseUrl: urlUtils_1.adminUserDeletionsUrl(),
        ...
        rows: page.items.map(d => {
            ...
            const row = [
                ...
                },
                {
                    ...
                    stretch: true,
                    url: isDone ? '' : urlUtils_1.userUrl(d.user_id),
                },
                {
                    value: strings_1.yesOrNo(d.process_data),
                },
                {
                    value: strings_1.yesOrNo(d.process_account),
                },
                {
                    value: time_1.formatDateTime(d.scheduled_time),
                },
                {
                    value: time_1.formatDateTime(d.start_time),
                },
                {
                    value: time_1.formatDateTime(d.end_time),
                },
                {
                    value: d.end_time ? strings_1.yesOrNo(d.success) : '-',
                },
                {
                    value: d.error,
                },
    ...
    const view = defaultView_1.default('admin/user_deletions', 'User deletions');
    view.content = {
        userDeletionTable: table_1.makeTableView(table),
        postUrl: urlUtils_1.adminUserDeletionsUrl(),
...
router.post('admin/user_deletions', (_path, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return routeUtils_1.redirect(ctx, urlUtils_1.adminUserDeletionsUrl());
}));
