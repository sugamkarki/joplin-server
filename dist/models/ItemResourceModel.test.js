...
describe('ItemResourceModel', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('ItemResourceModel');
    }));
    ...
    test('should get an item tree', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const tree = yield testUtils_1.models().itemResource().itemTree(rootNote.id, rootNote.jop_id);
        expect(tree).toEqual({
            item_id: rootNote.id,
    ...
    test('should not go into infinite loop when a note links to itself', () => __awaiter(this, void 0, void 0, function* () {
        ...
        const linkedNote = yield testUtils_1.createNote(session.id, {
