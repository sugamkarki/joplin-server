...
class ShareModel extends BaseModel_2.default {
    ...
    checkIfAllowed(user, action, resource = null) {
        return __awaiter(this, void 0, void 0, function* () {
            if (action === BaseModel_2.AclAction.Create) {
                if (resource.type === types_1.ShareType.Folder && !user_1.getCanShareFolder(user))
    ...
    checkShareUrl(share, shareUrl) {
        if (this.baseUrl === this.userContentBaseUrl)
            return; // OK
        const userId = routeUtils_1.userIdFromUserContentUrl(shareUrl);
    ...
    shareUrl(shareOwnerId, id, query = null) {
        return urlUtils_1.setQueryParameters(`${this.personalizedUserContentBaseUrl(shareOwnerId)}/shares/${id}`, query);
    }
    byItemId(itemId) {
        return __awaiter(this, void 0, void 0, function* () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const addUserItem = (shareUserId, itemId) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if (!db_1.isUniqueConstraintError(error))
                        throw error;
                }
            });
            ...
            while (true) {
                ...
                if (!changes.length) {
                    ...
                    const shareIds = array_1.unique(items.filter(i => !!i.jop_share_id).map(i => i.jop_share_id));
    ...
    updateResourceShareStatus(doShare, _shareId, changerUserId, toUserId, resourceIds) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resourceBlobNames = resourceIds.map(id => joplinUtils_1.resourceBlobPath(id));
