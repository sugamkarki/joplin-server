...
describe('NotificationModel', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('NotificationModel');
    }));
    ...
    test('should require a user to create the notification', function () {
        return __awaiter(this, void 0, void 0, function* () {
            yield testUtils_1.expectThrow(() => __awaiter(this, void 0, void 0, function* () { return testUtils_1.models().notification().add('', NotificationModel_1.NotificationKey.EmailConfirmed, types_1.NotificationLevel.Normal, NotificationModel_1.NotificationKey.EmailConfirmed); }));
        });
    });
    test('should create a notification', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const { user } = yield testUtils_1.createUserAndSession(1, true);
            const model = testUtils_1.models().notification();
