    ...
    acquireSyncLock(userId, clientType, clientId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.models().keyValue().readThenWrite(userKey, (value) => __awaiter(this, void 0, void 0, function* () {
                ...
                const exclusiveLock = LockHandler_1.activeLock(locks, new Date(), this.lockTtl, LockHandler_1.LockType.Exclusive);
                if (exclusiveLock) {
                ...
                const syncLock = LockHandler_1.activeLock(locks, new Date(), this.lockTtl, LockHandler_1.LockType.Sync, clientType, clientId);
                if (syncLock) {
    ...
    acquireExclusiveLock(userId, clientType, clientId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.models().keyValue().readThenWrite(userKey, (value) => __awaiter(this, void 0, void 0, function* () {
                ...
                const syncLock = LockHandler_1.activeLock(locks, new Date(), this.lockTtl, LockHandler_1.LockType.Sync);
                if (syncLock) {
