...
const newTestModels = (driverConfig, driverConfigFallback = null) => {
    const newConfig = Object.assign(Object.assign({}, config_1.default()), { storageDriver: driverConfig, storageDriverFallback: driverConfigFallback });
    return factory_1.default(testUtils_1.db(), newConfig);
};
function shouldWriteToContentAndReadItBack(driverConfig) {
    test('should write to content and read it back', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const noteBody = testUtils_1.makeNoteSerializedBody({
            ...
            const rawContent = yield driver.read(item.id, { models: testUtils_1.models() });
...
function shouldNotUpdateItemIfContentNotSaved(driverConfig) {
    test('should not update the item if the content cannot be saved', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const noteBodyMod1 = testUtils_1.makeNoteSerializedBody({
                id: '00000000000000000000000000000001',
                title: 'updated 1',
            });
            yield testModels.item().saveFromRawContent(user, [{
            ...
            const noteBodyMod2 = testUtils_1.makeNoteSerializedBody({
                id: '00000000000000000000000000000001',
                title: 'updated 2',
            });
            const previousWrite = driver.write;
...
function shouldSupportFallbackDriver(driverConfig, fallbackDriverConfig) {
    test('should support fallback content drivers', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const output = yield testModels.item().saveFromRawContent(user, [{
                    name: '00000000000000000000000000000001.md',
                    body: Buffer.from(testUtils_1.makeNoteSerializedBody({
                        id: '00000000000000000000000000000001',
                        title: 'testing',
                    })),
                }]);
            ...
            {
                const content = yield driver.read(itemId, { models: testUtils_1.models() });
                ...
                }]);
            {
                ...
                const context = { models: testUtils_1.models() };
...
function shouldThrowNotFoundIfNotExist(driverConfig) {
    test('should throw not found if item does not exist', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const driver = yield loadStorageDriver_1.default(driverConfig, testUtils_1.db());
            let error = null;
            try {
                yield driver.read('doesntexist', { models: testUtils_1.models() });
            }
            catch (e) {
                error = e;
            }
