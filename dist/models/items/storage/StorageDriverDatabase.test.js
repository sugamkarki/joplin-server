...
const newDriver = () => {
    return new StorageDriverDatabase_1.default(1, {
        dbClientType: db_1.clientType(testUtils_1.db()),
    });
};
const newConfig = () => {
    return {
...
describe('StorageDriverDatabase', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('StorageDriverDatabase');
    }));
    ...
    test('should fail if the item row does not exist', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield testUtils_1.expectThrow(() => __awaiter(this, void 0, void 0, function* () { return driver.read('oops', { models: testUtils_1.models() }); }));
        });
    });
    test('should do nothing if deleting non-existing row', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const driver = newDriver();
            yield testUtils_1.expectNotThrow(() => __awaiter(this, void 0, void 0, function* () { return driver.delete('oops', { models: testUtils_1.models() }); }));
        });
    });
});
