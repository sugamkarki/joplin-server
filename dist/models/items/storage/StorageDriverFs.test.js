...
const basePath_ = testUtils_1.tempDirPath();
...
describe('StorageDriverFs', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('StorageDriverFs');
    }));
    ...
    afterEach(() => __awaiter(this, void 0, void 0, function* () {
        yield fs_extra_1.remove(basePath_);
        yield fs_extra_1.mkdirp(basePath_);
    }));
    ...
    testUtils_2.shouldSupportFallbackDriver(newConfig(), { type: types_1.StorageDriverType.Memory });
    testUtils_2.shouldSupportFallbackDriverInReadWriteMode(newConfig(), { type: types_1.StorageDriverType.Memory, mode: types_1.StorageDriverMode.ReadAndWrite });
    testUtils_2.shouldUpdateContentStorageIdAfterSwitchingDriver(newConfig(), { type: types_1.StorageDriverType.Memory });
    ...
    test('should automatically create the base path', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const tmp = `${testUtils_1.tempDirPath()}/testcreate`;
            expect(yield fs_extra_1.pathExists(tmp)).toBe(false);
            const driver = newDriver(tmp);
            yield driver.write('testing', Buffer.from('testing'));
            expect(yield fs_extra_1.pathExists(tmp)).toBe(true);
        });
    });
    test('should not throw if deleting a file that does not exist', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const driver = newDriver();
            yield testUtils_1.expectNotThrow(() => __awaiter(this, void 0, void 0, function* () { return driver.delete('notthere'); }));
        });
    });
});
