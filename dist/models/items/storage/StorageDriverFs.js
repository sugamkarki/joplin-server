...
class StorageDriverFs extends StorageDriverBase_1.default {
    ...
    createParentDirectories(path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.pathCreated_[basename])
                return;
            yield fs_extra_1.mkdirp(basename);
    ...
    write(itemId, content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield fs_extra_1.writeFile(itemPath, content);
        });
    }
    read(itemId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield fs_extra_1.readFile(this.itemPath(itemId));
                return result;
            }
            catch (error) {
    ...
    delete(itemId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const id of itemIds) {
                try {
                    yield fs_extra_1.remove(this.itemPath(id));
                }
                catch (error) {
                    if (error.code === 'ENOENT')
                        throw new errors_1.CustomError(`Not found: ${itemId}`, errors_1.ErrorCode.NotFound);
    ...
    exists(itemId) {
        return __awaiter(this, void 0, void 0, function* () {
            return fs_extra_1.pathExists(this.itemPath(itemId));
        });
    }
}
