...
describe('parseStorageConnectionString', function () {
    test('should parse a connection string', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const [connectionString, config] of Object.entries(testCases)) {
                const actual = parseStorageConnectionString_1.default(connectionString);
    ...
    test('should detect errors', function () {
        return __awaiter(this, void 0, void 0, function* () {
            expect(() => parseStorageConnectionString_1.default('Path=/path/to/dir')).toThrow(); // Type is missing
            expect(() => parseStorageConnectionString_1.default('Type=')).toThrow();
            expect(() => parseStorageConnectionString_1.default('Type;')).toThrow();
            expect(() => parseStorageConnectionString_1.default('Type=DoesntExist')).toThrow();
            expect(() => parseStorageConnectionString_1.default('Type=Filesystem')).toThrow();
        });
    });
});
