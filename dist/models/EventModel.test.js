...
describe('EventModel', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('EventModel');
    }));
    ...
    test('should create an event', function () {
        return __awaiter(this, void 0, void 0, function* () {
            yield testUtils_1.models().event().create(types_1.EventType.TaskStarted, 'deleteExpiredTokens');
            const events = yield testUtils_1.models().event().all();
    ...
    test('should get the latest event', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield testUtils_1.models().event().create(types_1.EventType.TaskStarted, 'deleteExpiredTokens');
            const allEvents = (yield testUtils_1.models().event().all()).sort((a, b) => a.created_time < b.created_time ? -1 : +1);
            expect(allEvents[0].created_time).toBeLessThan(allEvents[1].created_time);
            const latest = yield testUtils_1.models().event().lastEventByTypeAndName(types_1.EventType.TaskStarted, 'deleteExpiredTokens');
