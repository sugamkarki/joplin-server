    ...
    handlePayment(stripeSubscriptionId, success) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (success) {
                ...
                yield this.models().email().push(Object.assign(Object.assign({}, paymentFailedTemplate_1.default()), { recipient_email: user.email, recipient_id: user.id, recipient_name: user.full_name || '', sender_id: types_1.EmailSender.Support }));
            }
        });
    }
