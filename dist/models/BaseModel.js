...
class BaseModel {
    ...
    personalizedUserContentBaseUrl(userId) {
        return personalizedUserContentBaseUrl_1.default(userId, this.baseUrl, this.userContentBaseUrl);
    }
    get appName() {
    ...
    allPaginated(pagination, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            pagination = Object.assign(Object.assign({}, pagination_1.defaultPagination()), pagination);
    ...
    save(object, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.hasUuid() && isNew && !toSave.id) {
                toSave.id = this.uuidType() === UuidType.NanoId ? uuidgen_1.default() : dbuuid_1.default();
            }
