...
class ItemModel extends BaseModel_1.default {
    ...
    loadStorageDriver(config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!driver) {
                driver = yield loadStorageDriver_1.default(config, this.db);
    ...
    loadAsSerializedJoplinItem(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return joplinUtils_1.serializeJoplinItem(yield this.loadAsJoplinItem(id));
        });
    }
    serializedContent(item) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (item.jop_type > 0) {
                return Buffer.from(yield joplinUtils_1.serializeJoplinItem(this.itemToJoplinItem(item)));
            }
            else {
                return item.content;
            }
    ...
    atomicMoveContent(item, toDriver, drivers, logger) {
        return __awaiter(this, void 0, void 0, function* () {
            for (let i = 0; i < 10; i++) {
                ...
                if (!fromDriver) {
                    fromDriver = yield loadStorageDriver_1.default(item.content_storage_id, this.db);
                ...
                const updatedRows = yield this
                    ...
                    .update({ content_storage_id: toDriver.storageId }, db_1.returningSupported(this.db) ? ['id'] : undefined);
                ...
                if (!db_1.returningSupported(this.db) || updatedRows.length)
                    return;
                ...
                yield time_1.msleep(1000 + 1000 * i);
            }
    ...
    deleteDatabaseContentColumn(options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!db_1.returningSupported(this.db))
    ...
    saveFromRawContent(user, rawContentItems, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const rawItem of rawContentItems) {
                try {
                    const isJoplinItem = joplinUtils_1.isJoplinItemName(rawItem.name);
                    let isNote = false;
                    const item = {
                        name: rawItem.name,
                    };
                    ...
                    let resourceIds = [];
                    if (isJoplinItem) {
                        joplinItem = yield joplinUtils_1.unserializeJoplinItem(rawItem.body.toString());
                        isNote = joplinItem.type_ === BaseModel_2.ModelType.Note;
                        resourceIds = isNote ? joplinUtils_1.linkedResourceIds(joplinItem.body) : [];
    ...
    children(userId, pathQuery = '', pagination = null, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            pagination = pagination || pagination_1.defaultPagination();
            const query = this.childrenQuery(userId, pathQuery, false, options);
            return pagination_1.paginateDbQuery(query, pagination, 'items');
        });
    }
    ...
    shouldRecordChange(itemName) {
        if (joplinUtils_1.isJoplinItemName(itemName))
            return true;
        if (joplinUtils_1.isJoplinResourceBlobPath(itemName))
            return true;
        return false;
    }
    ...
    deleteAll(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            while (true) {
                const page = yield this.children(userId, '', Object.assign(Object.assign({}, pagination_1.defaultPagination()), { limit: 1000 }));
            ...
            try {
                while (true) {
                    ...
                    if (!changes.length) {
                        ...
                        const itemIds = array_1.unique(changes.map(c => c.item_id));
                        const userItems = yield this.db('user_items').select('user_id').whereIn('item_id', itemIds);
                        const userIds = array_1.unique(userItems
                            .map(u => u.user_id)
