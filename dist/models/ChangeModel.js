...
class ChangeModel extends BaseModel_1.default {
    ...
    compressChanges(changes) {
        ...
        for (const change of changes) {
            ...
            if (change.type === types_1.ChangeType.Update) {
                const key = crypto_1.md5(itemId + change.previous_item);
    ...
    compressOldChanges(ttl = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logger.info(`compressOldChanges: Processing changes older than: ${time_1.formatDateTime(cutOffDate)} (${cutOffDate})`);
            while (true) {
