...
describe('db', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('db', { autoMigrate: false });
    }));
    ...
    it('should allow upgrading and downgrading schema', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                yield db_1.migrateUp(testUtils_1.db());
                if (!startProcessing) {
                    const next = yield db_1.nextMigration(testUtils_1.db());
                ...
                if (!next)
                    break;
                const initialSchema = yield dbSchemaSnapshot(testUtils_1.db());
                yield db_1.migrateUp(testUtils_1.db());
                const afterUpgradeSchema = yield dbSchemaSnapshot(testUtils_1.db());
                ...
                yield db_1.migrateDown(testUtils_1.db());
                const afterRollbackSchema = yield dbSchemaSnapshot(testUtils_1.db());
