        ...
        return __awaiter(this, void 0, void 0, function* () {
            const commands = {
                create: () => __awaiter(this, void 0, void 0, function* () {
                    yield dbTools_1.createDb(config_1.default().database);
                }),
                dropTables: () => __awaiter(this, void 0, void 0, function* () {
                    const db = yield db_1.connectDb(config_1.default().database);
                    yield db_1.dropTables(db);
                    yield db_1.disconnectDb(db);
                }),
            };
