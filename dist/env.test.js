...
describe('env', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('env');
    }));
    ...
    it('should overrides default values', function () {
        return __awaiter(this, void 0, void 0, function* () {
            expect(env_1.parseEnv({}).POSTGRES_USER).toBe('joplin');
            expect(env_1.parseEnv({}, { POSTGRES_USER: 'other' }).POSTGRES_USER).toBe('other');
        });
    });
    it('should validate values', function () {
        return __awaiter(this, void 0, void 0, function* () {
            yield testUtils_1.expectThrow(() => __awaiter(this, void 0, void 0, function* () { return env_1.parseEnv({ POSTGRES_PORT: 'notanumber' }); }));
            yield testUtils_1.expectThrow(() => __awaiter(this, void 0, void 0, function* () { return env_1.parseEnv({ MAILER_ENABLED: 'TRUE' }); }));
        });
    });
});
