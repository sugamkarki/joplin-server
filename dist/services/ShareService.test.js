...
describe('ShareService', function () {
    beforeAll(() => __awaiter(this, void 0, void 0, function* () {
        yield testUtils_1.beforeAllDb('ShareService');
    }));
    ...
    test('should run maintenance when an item is changed', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const service = new ShareService_1.default(types_1.Env.Dev, testUtils_1.models(), config_1.default());
            ...
            const folderItem = yield testUtils_1.models().item().loadByJopId(user1.id, '000000000000000000000000000000F2');
            ...
            yield testUtils_1.updateNote(session1.id, Object.assign(Object.assign({}, note), { parent_id: '000000000000000000000000000000F1', share_id: '' }));
            ...
            // 2's children.
            const children = yield testUtils_1.models().item().children(user2.id);
