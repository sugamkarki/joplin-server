...
class EmailService extends BaseService_1.default {
    transport() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.transport_) {
                try {
                    if (!email_1.senderInfo(types_1.EmailSender.NoReply).email) {
                    ...
                    this.transport_ = nodemailer_1.createTransport(options);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const email of emails) {
                    const sender = email_1.senderInfo(email.sender_id);
                    const mailOptions = {
                        ...
                        text: utils_1.markdownBodyToPlainText(email.body),
                        html: utils_1.markdownBodyToHtml(email.body),
                    };
                    const emailToSave = {
                        id: email.id,
                        sent_time: Date.now(),
                    ...
                    try {
                        ...
                        emailToSave.error = errors_1.errorToString(error);
                    }
