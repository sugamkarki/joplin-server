...
function renderNote(share, note, resourceInfos, linkedItemInfos) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield markupToHtml.render(note.markup_language, note.body, theme_1.themeStyle(Setting_1.default.THEME_LIGHT), renderOptions);
        const bodyHtml = yield mustache_.renderView({
            cssFiles: ['items/note'],
            jsFiles: ['items/note'],
            name: 'note',
            title: `${substrWithEllipsis(note.title, 0, 100)} - ${config_1.default().appName}`,
            titleOverride: true,
            path: 'index/items/note',
            content: {
                note: Object.assign(Object.assign({}, note), { bodyHtml: result.html, updatedDateTime: time_1.formatDateTime(note.updated_time) }),
...
function itemIsEncrypted(item) {
    ...
    return EncryptionService_1.isValidHeaderIdentifier(header);
}
