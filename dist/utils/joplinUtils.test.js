    ...
    it('should check if an item is encrypted', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const [expected, input] of testCases) {
                expect(joplinUtils_1.itemIsEncrypted(input)).toBe(expected);
            }
            yield testUtils_1.expectThrow(() => __awaiter(this, void 0, void 0, function* () { return joplinUtils_1.itemIsEncrypted({ name: 'missing props' }); }));
        });
    });
});
