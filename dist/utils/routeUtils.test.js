...
describe('routeUtils', function () {
    it('should parse a route path', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const t of testCases) {
                ...
                const parsed = routeUtils_1.parseSubPath('', path);
    ...
    it('should find a matching route', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const testCase of testCases) {
                ...
                const actual = routeUtils_1.findMatchingRoute(path, routes);
                expect(actual).toEqual(expected);
            }
            yield testUtils_1.expectThrow(() => __awaiter(this, void 0, void 0, function* () { return routeUtils_1.findMatchingRoute('help', routes); }));
            yield testUtils_1.expectThrow(() => __awaiter(this, void 0, void 0, function* () { return routeUtils_1.findMatchingRoute('api/users/123', routes); }));
        });
    });
    it('should split an item path', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const t of testCases) {
                const path = t[0];
                const expected = t[1];
                const splitted = routeUtils_1.splitItemPath(path);
    ...
    it('should check the request origin for API URLs', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const testCase of testCases) {
                ...
                expect(routeUtils_1.isValidOrigin(requestOrigin, configBaseUrl, types_2.RouteType.Api)).toBe(expected);
            }
        });
    });
    it('should check the request origin for User Content URLs', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const testCase of testCases) {
                const [requestOrigin, configBaseUrl, expected] = testCase;
                expect(routeUtils_1.isValidOrigin(requestOrigin, configBaseUrl, types_2.RouteType.UserContent)).toBe(expected);
            }
        });
    });
    it('should check if a URL matches a schema', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const testCase of testCases) {
                ...
                const actual = routeUtils_1.urlMatchesSchema(url, schema);
