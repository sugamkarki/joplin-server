...
function setupServices(env, models, config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        output.tasks = setupTaskService_1.default(env, models, config, output),
...
function default_1(appContext, env, dbConnection, appLogger) {
    return __awaiter(this, void 0, void 0, function* () {
        const models = factory_1.default(dbConnection, config_1.default());
        ...
        appContext.joplinBase = Object.freeze({
            ...
            db: dbConnection,
            models: models,
            services: yield setupServices(env, models, config_1.default()),
            appLogger: appLogger,
