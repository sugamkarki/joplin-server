...
function default_1(connection, db, models) {
    return __awaiter(this, void 0, void 0, function* () {
        const storageConfig = typeof connection === 'string' ? parseStorageConnectionString_1.default(connection) : connection;
        ...
        const driver = yield loadStorageDriver_1.default(storageConfig, db, { assignDriverId: false });
        const itemId = `testingconnection${uuidgen_1.default(8)}`;
        const itemContent = Buffer.from(uuidgen_1.default(8));
