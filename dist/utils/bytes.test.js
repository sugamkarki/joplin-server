...
describe('bytes', function () {
    ...
    it('should display pretty bytes', function () {
        return __awaiter(this, void 0, void 0, function* () {
            expect(bytes_1.formatBytes(100 * bytes_1.KB)).toBe('100 kB');
            expect(bytes_1.formatBytes(200 * bytes_1.MB)).toBe('200 MB');
            expect(bytes_1.formatBytes(3 * bytes_1.GB)).toBe('3 GB');
        });
    });
});
