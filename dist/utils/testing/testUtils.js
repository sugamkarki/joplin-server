...
function beforeAllDb(unitName, createDbOptions = null) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (process.env.JOPLIN_TESTS_SERVER_DB === 'pg') {
            yield config_1.initConfig(types_1.Env.Dev, env_1.parseEnv({
                DB_CLIENT: 'pg',
        ...
        initGlobalLogger();
        yield dbTools_1.createDb(config_1.default().database, Object.assign({ dropIfExists: true }, createDbOptions));
        db_ = yield db_1.connectDb(config_1.default().database);
        const mustache = new MustacheService_1.default(config_1.default().viewDir, config_1.default().baseUrl);
        yield mustache.loadPartials();
        yield joplinUtils_1.initializeJoplinUtils(config_1.default(), models(), mustache);
    });
}
...
function koaAppContext(options = null) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const csrfToken = owner ? yield csrf_1.createCsrfToken(models(), owner) : '';
        ...
        const baseAppContext = yield setupAppContext_1.default({}, types_1.Env.Dev, db_, () => appLogger);
        ...
        const appContext = {
            ...
            method: req.method,
            redirect: () => { },
            URL: new url_1.URL(config_1.default().baseUrl),
        };
        if (options.sessionId) {
            cookies_1.cookieSet(appContext, 'sessionId', options.sessionId);
        }
        return appContext;
    });
}
...
exports.db = db;
function models() {
    return factory_1.default(db(), config_1.default());
}
...
function getItem(sessionId, path) {
    return __awaiter(this, void 0, void 0, function* () {
        const item = yield apiUtils_1.getApi(sessionId, `items/${path}/content`);
...
function createItem(sessionId, path, content) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const item = yield apiUtils_1.putApi(sessionId, `items/${path}/content`, null, { filePath: tempFilePath });
