    ...
    for (let i = 0; i < menuItems.length; i++) {
        ...
        if (menuItem.url) {
            if (menuItem.selectedCondition) {
                ...
                selected = routeUtils_1.urlMatchesSchema(menuItem.url, selectedPath.schema);
            }
        }
        menuItems[i] = Object.assign(Object.assign({}, menuItem), { selected, children: exports.setSelectedMenu(selectedPath, menuItem.children) });
    }
    return menuItems;
};
