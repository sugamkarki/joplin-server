...
exports.tablePartials = exports.makeTableView = exports.makeTablePagination = void 0;
...
function makeTablePagination(query, defaultOrderField, defaultOrderDir) {
    ...
    const order = pagination_1.requestPaginationOrder(query, defaultOrderField, defaultOrderDir);
    const page = 'page' in query ? Number(query.page) : 1;
    const output = { limit, order, page };
    pagination_1.validatePagination(output);
    return output;
}
...
function makeHeaderView(header, parentBaseUrl, baseUrlQuery, pagination) {
    ...
    return {
        label: header.label,
        sortLink: !pagination || !canSort ? null : urlUtils_1.setQueryParameters(parentBaseUrl, Object.assign(Object.assign({}, baseUrlQuery), { 'order_by': header.name, 'order_dir': headerNextOrder(header.name, pagination) })),
...
function makeTableView(table) {
    ...
    if (table.pageCount) {
        ...
        baseUrlQuery = pagination_1.filterPaginationQueryParams(table.requestQuery);
        pagination = table.pagination;
        paginationLinks = pagination_1.createPaginationLinks(pagination.page, table.pageCount, urlUtils_1.setQueryParameters(table.baseUrl, Object.assign(Object.assign({}, baseUrlQuery), { 'page': 'PAGE_NUMBER' })));
    }
    return {
